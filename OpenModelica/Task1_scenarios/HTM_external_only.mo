...
equation
  connect(HTM.T_int, T_int.y) annotation(
    Line(points = {{-12, 24}, {-40, 24}, {-40, 74}, {-56, 74}, {-56, 74}}, color = {0, 0, 127}));
  connect(HTM.T_ext, T_ext.y) annotation(
    Line(points = {{-14, 8}, {-48, 8}, {-48, -42}, {-58, -42}, {-58, -42}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    experiment(StartTime = 0, StopTime = 86400, Tolerance = 1e-6, Interval = 86.4));end HTM_external_only;