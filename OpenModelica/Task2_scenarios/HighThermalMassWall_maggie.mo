within RCNetworks;
model HighThermalMassWall_maggie
  ...
  RCNetworks.RCElements.Layer X1(
    C={5.37} * 1000,
    R={3.522, 3.522}/2,
  ...
  RCNetworks.RCElements.Layer B6(
    C={17.046} * 1000,
    R={3.152, 3.152}/2,
    T_start=T_start, use_externalQ = false, use_internalQ = false)
...
equation
  connect(E1.port_b, senT_int.port) annotation(
    Line(points = {{60, 4}, {68, 4}, {68, 80}, {74, 80}, {74, 80}}, color = {191, 0, 0}));
  connect(A2.port_a, senT_ext.port) annotation(
    Line(points = {{-86, 4}, {-92, 4}, {-92, -32}, {46, -32}, {46, -50}, {58, -50}, {58, -50}}, color = {191, 0, 0}));
  ...
  connect(q_ext, A2.q_ext) annotation(
    Line(points = {{-120, -18}, {-94, -18}, {-94, 0}, {-88, 0}, {-88, 0}}, color = {0, 0, 127}));
  ...
  connect(E0.port_b, heatFlowSensor_int.port_b) annotation(
    Line(points = {{-32, 80}, {-32, 80}, {-32, 70}, {56, 70}, {56, 56}, {46, 56}, {46, 54}, {46, 54}}, color = {191, 0, 0}));
  connect(E1.port_b, heatFlowSensor_int.port_a) annotation(
    Line(points = {{60, 4}, {66, 4}, {66, 36}, {16, 36}, {16, 54}, {26, 54}, {26, 54}}, color = {191, 0, 0}));
...
end HighThermalMassWall_maggie;